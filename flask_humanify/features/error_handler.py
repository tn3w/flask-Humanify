...
ERROR_CODES = {
    ...
    406: {
        ...
        "description": (
            ...
            "acceptable values defined in your request's proactive "
    ...
    408: {
        ...
        "description": (
            "The server did not receive a complete request message from "
            "you within the time that it was prepared to wait."
        ),
    },
    409: {
        "title": "Conflict",
    ...
    412: {
        ...
        "description": (
            "The server does not meet one of the preconditions that you "
            "put on the request header fields."
        ),
    },
    413: {
    ...
    414: {
        "title": "URI Too Long",
        "description": (
            "The URI requested by you is longer than the server is "
    ...
    416: {
        ...
        "description": (
            "The range specified by the Range header field in your "
    ...
    417: {
        ...
        "description": (
            "The expectation given in your request's Expect header field "
    ...
    418: {
        "title": "I'm a teapot",
        "description": (
            "The web server rejects the attempt to make coffee with a teapot."
        ),
    },
    422: {
    ...
    431: {
        ...
        "description": (
            "The server is unwilling to process your request because its "
    ...
    504: {
        ...
        "description": (
            "The server is acting as a gateway or proxy and did not "
    ...
    505: {
        ...
        "description": (
            "The HTTP version used in your request is not supported by the server."
        ),
    },
}
...
class ErrorHandler:
    def __init__(self, app=None, errors=None, template_path=None):
        self.app = app
        self.errors = errors
    ...
    def handle_error(self, error):
        ...
        message = info.get("description", "An error occurred")
